...
char cur_dir[MAX_CURDIR_PATH] = "ux0:data/srb2vita/";
...
void D_SRB2Main(void)
{
...

	{
		...
		if (!userhome)
		{
#if ((defined (__unix__) && !defined (MSDOS)) || defined(__APPLE__) || defined (UNIXCOMMON)) && !defined (__CYGWIN__) && !defined (DC) && !defined (PSP) && !defined(__vita__) && !defined(GP2X) && !defined(__SWITCH__)
